const press = ()=>{
    ...
    switch(randomX){
        case 1 : image.setAttribute("src","images/1.svg")
                 headingEle.innerHTML = "koi nhi sbka smay aata hai"   
                 break
        case 2 : image.setAttribute("src","images/2.svg")
                 headingEle.innerHTML = "o hoo"   
                 break          
        case 3 : image.setAttribute("src","images/3.svg")
                 headingEle.innerHTML = " itna chalta hai yaar"   
                 break
        case 4 : image.setAttribute("src","images/4.svg")
                 headingEle.innerHTML = "thik hi hai"   
                 break                 
        case 5 : image.setAttribute("src","images/5.svg")
                 headingEle.innerHTML = "o triii thoda sa reh gya yaar!!!"   
                 break
        case 6 : image.setAttribute("src","images/6.svg")
